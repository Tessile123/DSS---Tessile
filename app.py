...
if "passaporto" in params:
    ...
    st.markdown("""
            ...
            .c3 { left: 35%; animation-duration: 3.5s; animation-delay: 1s; }
            .c4 { left: 45%; animation-duration: 4.5s; animation-delay: 2.8s; }
            .c5 { left: 70%; animation-duration: 3.5s; animation-delay: 1.5s; }
            .c6 { left: 80%; animation-duration: 3.5s; animation-delay: 0.5s; }
            .c7 { left: 80%; animation-duration: 3.2s; animation-delay: 2.5s; }
            </style>
